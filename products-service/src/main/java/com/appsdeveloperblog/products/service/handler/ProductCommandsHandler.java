...
public class ProductCommandsHandler {
    ...
    @KafkaHandler
    public void handleProductCommandsEvent(@Payload ReserveProductCommand reserveProductCommand) {
        try {
            Product desiredProduct = new Product(reserveProductCommand.getProductId(), reserveProductCommand.getProdcutQuantity());
            ...
            ProductReservedEvent productReservedEvent = new ProductReservedEvent(
                    ...
                    reserveProductCommand.getProdcutQuantity());
            kafkaTemplate.send(productEventsTopicName, productReservedEvent);
        } catch (Exception e) {
            logger.error(e.getLocalizedMessage(), e);
            ProductReservationFailedEvent failedEvent = new ProductReservationFailedEvent(reserveProductCommand.getProductId(),
                    reserveProductCommand.getOrderId(),
                    reserveProductCommand.getProdcutQuantity());
